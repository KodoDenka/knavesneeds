    ...
    public void buildRecipes(Consumer<FinishedRecipe> exporter) {
        ...
        if (platform.equals("fabric") || platform.equals("forge")) {
            ...
            for (var item : DeeperDarkerAdditionsRegistries.WARDEN_ITEMS) {
                Constants.LOG.info("Attempting to make recipe for item: {}", item.get());
                ConditionalSmithingRecipeBuilder.smithing(item, exporter, wardenTemplate, echoShard, "simply_swords", "netherite_","deeperdarker", platform);
            }
        ...
        if (platform.equals("fabric")) {
            ...
            for (var item : BetterNetherAdditionsRegistries.CINCINNASITE_DIAMOND_ITEMS) {
                Constants.LOG.info("Attempting to make recipe for item: {}", item.get());
                ConditionalSmithingRecipeBuilder.smithing(item, exporter, Ingredient.of(Items.STONE), Ingredient.of(Items.DIAMOND), "simply_swords","diamond_", "better_nether", platform);
            }
