...
public class KnavesRecipeProvider extends FabricRecipeProvider {
    ...
    public void buildRecipes(Consumer<FinishedRecipe> exporter) {
        ...
        for (var item : AmethystImbuementAdditionsRegistries.AMETRINE_ITEMS) {
            ...
            CommonRecipeGenerator.buildRecipesFor(item, exporter, Ingredient.of(TagKey.create(Registries.ITEM, new ResourceLocation("c", "wood_sticks"))), Ingredient.of(Items.STONE), Ingredient.of(Items.STONE));
        }
