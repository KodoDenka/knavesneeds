...
public class KnavesBlueSkiesConfig extends Config {
    ...
    @Comment("Material - Turquoise Stone")
    ...
    @Comment("Material - Bluebright Wood")
    ...
    @Comment("Material - Frostbright Wood")
