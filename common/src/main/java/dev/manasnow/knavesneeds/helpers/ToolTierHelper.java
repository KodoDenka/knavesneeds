...
public enum ToolTierHelper implements Tier {
    ...
    STEELEAF(twilightForestConfig.steeleafDurability, twilightForestConfig.steeleafMiningSpeedMultiplier,7.0f,3,9, "twilightforest:steeleaf_ingot"),
    IRONWOOD(twilightForestConfig.ironwoodDurability,6.5f,5.0f,2,25, "twilightforest:ironwood_ingot"),
    FIERY(twilightForestConfig.fieryDurability,9.0f,7.0f,4,10, "twilightforest:fiery_ingot"),
    KNIGHTMETAL(twilightForestConfig.knightmetalDurability,8.0f,6.0f,3,8, "twilightforest:knightmetal_ingot"),
    ...
    //AmethystImbuement
    AMETRINE(2550,9.5f,5f,4,18, "byg:pendorite_ingot"),
    GARNET(3151,7.5f,3.0f,3,12, "byg:pendorite_ingot"),
    GLOWING(333,11.5f,4.5f, 4,12, "byg:pendorite_ingot"),
    ...
    private final float tierDamageBonus;
    private final int tierLevel;
    private final int tierEnchantmentValue;
