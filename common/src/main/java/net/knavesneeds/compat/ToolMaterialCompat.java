...
public enum ToolMaterialCompat implements ToolMaterial {
    ...
    STEELEAF(131,8.0f,6.0f,3,9, "twilightforest:steeleaf_ingot"),
    ...
    //Undergarden Tiers
    CLOGGRUM(286,6.0f,3.0f,2,8,"undergarden:cloggrum_ingot"),
    FROSTSTEEL(575,7.0f,2.0f,2,20, "undergarden:froststeel_ingot"),
    UTHERIUM(1279,8.5f,3.5f,3,17, "undergarden:utherium_crystal"),
    FORGOTTEN(1876,8.0f,3.0f,4,2, "undergarden:forgotten_ingot"),
    ...
    DEORUM(1024,9.0f,3.5f,3,8, "forbidden_arcanus:deorum_ingot"),
    REINFORCED_DEORUM(2561,9.0f,3.5f,3,26, "forbidden_arcanus:dragon_scale"),
    DRACO_ARCANUS(2661,12.0f,7.0f,4,20, "forbidden_arcanus:stellarite_piece"),


    //Better End Tiers
    AETERNIUM(2196,10.0f,4.5f,5,18, "betterend:aeternium_ingot"),
    TERMINITE(1230,8.5f,3.0f, 3,14, "betterend:terminite_ingot"),
    THALLASIUM(320,7.0f,1.5f,2,12, "betterend:thallasium_ingot"),


    //Better Nether Tiers
    CINCINNASITE(512,6.2f,2.5f,2,16, "betternether:cincinnasite_ingot"),
    CINCINNASITE_DIAMOND(2061,8.2f,3.7f,3,14, "minecraft:diamond"),
    NETHER_RUBY(2561,9.2f,5.0f,4,22, "betternether:nether_ruby"),
